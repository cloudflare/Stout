...
func (s *S) TestInitMulti(c *check.C) {
	...
	options := s3.Options{
		...
		RedirectLocation: "http://github.com/zackbloom/goamz",
	...
	c.Assert(req.Header["X-Amz-Website-Redirect-Location"], check.DeepEquals, []string{"http://github.com/zackbloom/goamz"})
